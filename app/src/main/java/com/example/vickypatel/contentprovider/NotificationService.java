...
public class NotificationService extends IntentService {
    ...
    private void showNotification() {
        ...
        System.out.println("NotificationService.showNotification");
        ...
        NotificationCompat.Action replyAction = new NotificationCompat.Action.Builder(
                R.drawable.ic_fog, replyLabel, getReplyPendingIntent())
    ...
    private PendingIntent getReplyPendingIntent() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            System.out.println("NotificationService.broadcastReceiver");
            ...
            System.out.println("NotificationService.replyActivity");
